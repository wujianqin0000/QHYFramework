...
`-clientVersion` and `-resourceVersion`. Omitting the resource value selects the
next published revision; production orchestration should allocate it explicitly
to prevent concurrent jobs from racing.
