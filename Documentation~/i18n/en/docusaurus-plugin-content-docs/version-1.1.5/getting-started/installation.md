...
{
  "dependencies": {
    "com.wjq.qhy-framework": "https://github.com/wujianqin0000/QHYFramework.git#v1.1.5"
  }
}
```
...
assembly, and collectors. FTP host/user start empty; every new
platform starts at `v1.0.0`.

FTP passwords are not serialized after this change. Enter one for the Release Window
session or inject it through `QHY_FTP_PASSWORD`/CI secrets; never place it in a
URL, command line, project asset, or log.
